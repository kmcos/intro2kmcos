...
!******
integer(kind=iint), parameter, public :: fcc100 = 0
integer(kind=iint), public :: default_layer = fcc100
!****v* lattice/default_layer
! FUNCTION
!   The layer in which the model is initially in by default (only relevant for multi-lattice models).
!******
integer(kind=iint), public :: substrate_layer = fcc100
...
!******
integer(kind=iint), parameter, public :: fcc100_hol = 1
