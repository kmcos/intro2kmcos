...
xml = """<?xml version="1.0" ?>
<kmc version="(0, 3)">
    <meta author="Mie Andersen" email="mie@phys.au.dk" model_name="COoxRuO2_w_janaf" model_dimension="2" debug="0"/>
    ...
    <process_list>
        ...
        <process rate_constant="p_O2gas*bar*A/4./sqrt(2*pi*umass*m_O2/beta)*exp(beta*((E_O_bridge+E_O_cus)-mu_O2gas)*eV)" name="O2_desorption_bridge_right" enabled="True">
        ...
        <process rate_constant="p_O2gas*bar*A/4./sqrt(2*pi*umass*m_O2/beta)*exp(beta*(2*E_O_bridge-mu_O2gas)*eV)" name="O2_desorption_bridge_up" enabled="True">
            <condition species="O" coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0"/>
            <condition species="O" coord_layer="ruo2" coord_name="bridge" coord_offset="0 1 0"/>
            <action species="empty" coord_layer="ruo2" coord_name="bridge" coord_offset="0 0 0"/>
            <action species="empty" coord_layer="ruo2" coord_name="bridge" coord_offset="0 1 0"/>
        </process>
        <process rate_constant="p_O2gas*bar*A/4./sqrt(2*pi*umass*m_O2/beta)*exp(beta*((E_O_cus+E_O_bridge)-mu_O2gas)*eV)" name="O2_desorption_cus_right" enabled="True">
            <condition species="O" coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0"/>
            <condition species="O" coord_layer="ruo2" coord_name="bridge" coord_offset="1 0 0"/>
            <action species="empty" coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0"/>
            <action species="empty" coord_layer="ruo2" coord_name="bridge" coord_offset="1 0 0"/>
        </process>
        <process rate_constant="p_O2gas*bar*A/4./sqrt(2*pi*umass*m_O2/beta)*exp(beta*(2*E_O_cus-mu_O2gas)*eV)" name="O2_desorption_cus_up" enabled="True">
            <condition species="O" coord_layer="ruo2" coord_name="cus" coord_offset="0 0 0"/>
